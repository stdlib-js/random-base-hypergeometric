...
```javascript
import hypergeometric from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-hypergeometric@v0.2.2-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-hypergeometric@v0.2.2-deno/mod.js';
```
